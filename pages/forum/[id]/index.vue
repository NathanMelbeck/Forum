...
<template>
  <section class="min-h-screen h-fit py-8 w-full flex flex-col items-center justify-center space-y-8">
    <NuxtLink
        href="/"
    ...
    <NuxtLink
        ...
        class="hover:scale-110 transition duration-300 ease-in-out shadow-md cursor-pointer shadow-gray-200 bg-gray-100 rounded-lg space-x-20 p-4 h-fit text-slate-800 flex flex-row w-2/3 justify-around items-center"
    >
      <div>
