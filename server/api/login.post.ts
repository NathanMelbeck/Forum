...
import {HTTP_BAD_REQUEST, HTTP_NOT_FOUND, HTTP_SERVER_ERROR} from '~/common/constant/api';
import {ApiError, ApiResponse} from '~/common/type/api';
import {User} from '~/common/type/app';
import validatePassword from '~/server/bcrypt/validate_password';
import validator from 'validator';
import isRowDataPacket from '~/server/function/isRowDataPacket';
